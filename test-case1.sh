...
sleep 1
#####
echo "<validator send query and wallet try to prune query. Pruning should be failed>."

# validator send ibc query
sleep 1
echo ""
echo "-----validator send query------"
...
# wallet tries to prune ${query_id}. It sholud be failed.
echo ""
echo "-----wallet tries to prune ${query_id}. It should be failed------"
...
sleep 1
#####
echo "<validator tries to prune ${query_id}. It should be success>"

# validator prune ${query_id}
sleep 1
echo ""
echo "-----validator prune ${query_id}. It should be successed------"
